                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item d-flex align-items-center">
                                <button type="button" class="btn btn-rounded btn-success" onclick="window.location.href='?page=show_all'">
                                    <span class="btn-icon-start text-warning"><i class="fa fa-search"></i></span>Cari cepat
                                </button>
                            </li>
